...
export class TranslationService {
  ...
  private translations: Record<Lang, Record<string, string>> = {
    es: {
      ...
      'history.sort.toggle': 'Invertir el orden',
      ...
      'stats.period.week': 'Semana',
      'stats.period.month': 'Mes',
      'stats.period.year': 'Año',
      'stats.metric.distance': 'Distancia',
      'stats.metric.time': 'Tiempo',
      'stats.metric.climb': 'Desnivel',
      'stats.metric.count': 'Rutas',
      'stats.totals': 'Totales',
      'stats.since': 'Desde',
      'stats.routes': 'Rutas',
      'stats.active_days': 'Días activos',
      'stats.vs_previous': 'vs anterior',
      'stats.by_type': 'Por actividad',
      'stats.by_collection': 'Por colección',
      'stats.records': 'Tus récords',
      'stats.record.distance': 'Ruta más larga',
      'stats.record.climb': 'Más desnivel',
      'stats.record.duration': 'Más tiempo',
      'stats.record.speed': 'Más rápida',
      'stats.empty': 'Aún no hay nada que resumir',
      'stats.empty_hint': 'Graba tu primera ruta y aquí verás cómo evolucionas semana a semana.',
      ...
      'detail.exporting_route': 'Exportando ruta...',
      ...
      'detail.type.title': 'Cambiar actividad',
      'detail.type.subtitle': 'Cómo se grabó esta ruta, de verdad.',
      'detail.type.changed': 'Ahora es {type}',
      'detail.share_image': 'Compartir como imagen',
      'detail.actions': 'Acciones de la ruta',
      'detail.actions.title': 'Acciones',
      'detail.actions.subtitle': 'Lo que puedes hacer con esta ruta.',
      'detail.fullscreen': 'Pantalla completa',
      'detail.fullscreen_exit': 'Salir de pantalla completa',
      'detail.delete': 'Eliminar ruta',
      'detail.deleted': 'Ruta eliminada',
      'detail.gallery.position': '{index} de {total}',
      'detail.gallery.previous': 'Ruta anterior',
      'detail.gallery.next': 'Ruta siguiente',
      'detail.gallery.swipe': 'Desliza',
    ...
    en: {
      ...
      'history.sort.toggle': 'Reverse the order',
      ...
      'stats.metric.time': 'Time',
      'stats.metric.climb': 'Climb',
      'stats.metric.count': 'Routes',
      'stats.totals': 'Totals',
      'stats.since': 'Since',
      'stats.routes': 'Routes',
      'stats.active_days': 'Active days',
      'stats.vs_previous': 'vs previous',
      'stats.by_type': 'By activity',
      'stats.by_collection': 'By collection',
      'stats.records': 'Your records',
      'stats.record.distance': 'Longest route',
      'stats.record.climb': 'Most climb',
      'stats.record.duration': 'Longest time',
      'stats.record.speed': 'Fastest',
      'stats.empty': 'Nothing to summarise yet',
      'stats.empty_hint': 'Record your first route and this is where you will watch it add up.',
      ...
      'detail.exporting_route': 'Exporting route...',
      ...
      'detail.type.title': 'Change activity',
      'detail.type.subtitle': 'What this route was really recorded doing.',
      'detail.type.changed': 'Now filed as {type}',
      'detail.share_image': 'Share as an image',
      'detail.actions': 'Route actions',
      'detail.actions.title': 'Actions',
      'detail.actions.subtitle': 'What you can do with this route.',
      'detail.fullscreen': 'Full screen',
      'detail.fullscreen_exit': 'Leave full screen',
      'detail.delete': 'Delete route',
      'detail.deleted': 'Route deleted',
      'detail.gallery.position': '{index} of {total}',
      'detail.gallery.previous': 'Previous route',
      'detail.gallery.next': 'Next route',
      'detail.gallery.swipe': 'Swipe',
