...
export class TranslationService {
  ...
  private translations: Record<Lang, Record<string, string>> = {
    es: {
      ...
      'settings.legal.notice': 'Aviso legal',
      ...
      'history.sort.name': 'Nombre',

      'history.search.placeholder': 'Buscar por nombre, tipo o fecha',
      'history.search.clear': 'Limpiar búsqueda',
      'history.filters': 'Filtros',
      'history.filter.type': 'Tipo de actividad',
      'history.filter.sort': 'Ordenar por',
      'history.summary': '{count} rutas · {distance} km',
      'history.summary_one': '1 ruta · {distance} km',
      'history.select': 'Seleccionar',
      'history.select_all': 'Todas',
      'history.select_none': 'Ninguna',
      'history.move': 'Mover',
      'history.rename': 'Renombrar',
      'history.delete': 'Eliminar',
      'history.deleted': '{count} rutas eliminadas',
      'history.deleted_one': 'Ruta eliminada',
      'history.undo': 'Deshacer',
      'history.restored': 'Rutas restauradas',
      'history.moved': '{count} rutas movidas a {name}',
      'history.moved_one': 'Ruta movida a {name}',
      'history.moved_out': '{count} rutas sin colección',
      'history.moved_out_one': 'Ruta sin colección',
      'history.renamed': 'Nombre actualizado',
      'history.empty_collection': 'Esta colección aún no tiene rutas',
      'history.empty_collection_hint':
        'Mantén pulsada una ruta, selecciónala y usa Mover para traerla aquí.',
      'history.empty_ungrouped': 'Todas tus rutas están en alguna colección',

      'collections.all': 'Todas',
      'collections.none': 'Sin colección',
      'collections.new': 'Nueva colección',
      'collections.manage': 'Gestionar colecciones',
      'collections.manage.empty': 'Aún no has creado ninguna colección.',
      'collections.manage.hint':
        'Las colecciones son pestañas del historial: monte, caminata, entrenamiento... Una ruta puede estar solo en una.',
      'collections.create.title': 'Nueva colección',
      'collections.create.message': 'Ponle un nombre: monte, caminata, entrenamiento...',
      'collections.create.placeholder': 'Monte',
      'collections.create.confirm': 'Crear',
      'collections.created': 'Colección «{name}» creada',
      'collections.rename.title': 'Renombrar colección',
      'collections.duplicate': 'Ya tienes una colección con ese nombre',
      'collections.delete.title': 'Eliminar colección',
      'collections.delete.message':
        '¿Eliminar «{name}»? Las rutas que contiene no se borran: vuelven a quedar sin colección.',
      'collections.delete.confirm': 'Eliminar colección',
      'collections.deleted': 'Colección eliminada',
      'collections.move.title': 'Mover a',
      'collections.move.subtitle': '{count} rutas seleccionadas',
      'collections.move.subtitle_one': '1 ruta seleccionada',
      'collections.color': 'Color',
      'collections.order.up': 'Subir',
      'collections.order.down': 'Bajar',
      'collections.count': '{count} rutas',
      'collections.count_one': '1 ruta',
      'collections.count_zero': 'Vacía',

      'activity.rename.title': 'Nombre de la ruta',
      'activity.rename.message': 'Ponle un nombre para reconocerla de un vistazo.',
      'activity.rename.placeholder': 'Subida al puerto',
      ...
      'detail.rename': 'Renombrar ruta',
      'detail.delete': 'Eliminar ruta',
      'detail.deleted': 'Ruta eliminada',
      ...
      'tracking.permission_title': 'Preparando el mapa',
      'tracking.permission_message': 'Trackingfy está localizando tu posición.',
      'tracking.notif_paused_title': 'Rastreo en pausa',
      'tracking.notif_stats': '{distance} km · +{climb} m',
      'tracking.notif_stats_paused': '{distance} km · +{climb} m · {time}',
      'tracking.notif_action_pause': 'Pausar',
      'tracking.notif_action_resume': 'Reanudar',
      'tracking.notif_action_finish': 'Finalizar',
    ...
    en: {
      ...
      'settings.legal.notice': 'Legal notice',
      'settings.legal.cookies': 'Cookies',
      ...
      'history.sort.name': 'Name',

      'history.search.placeholder': 'Search by name, type or date',
      'history.search.clear': 'Clear search',
      'history.filters': 'Filters',
      'history.filter.type': 'Activity type',
      'history.filter.sort': 'Sort by',
      'history.summary': '{count} routes · {distance} km',
      'history.summary_one': '1 route · {distance} km',
      'history.select': 'Select',
      'history.select_all': 'All',
      'history.select_none': 'None',
      'history.move': 'Move',
      'history.rename': 'Rename',
      'history.delete': 'Delete',
      'history.deleted': '{count} routes deleted',
      'history.deleted_one': 'Route deleted',
      'history.undo': 'Undo',
      'history.restored': 'Routes restored',
      'history.moved': '{count} routes moved to {name}',
      'history.moved_one': 'Route moved to {name}',
      'history.moved_out': '{count} routes left ungrouped',
      'history.moved_out_one': 'Route left ungrouped',
      'history.renamed': 'Name updated',
      'history.empty_collection': 'This collection has no routes yet',
      'history.empty_collection_hint':
        'Long-press a route to select it, then use Move to bring it here.',
      'history.empty_ungrouped': 'Every route of yours is in a collection',

      'collections.all': 'All',
      'collections.none': 'No collection',
      'collections.new': 'New collection',
      'collections.manage': 'Manage collections',
      'collections.manage.empty': 'You have not created any collection yet.',
      'collections.manage.hint':
        'Collections are history tabs: trail, hiking, training... A route can only be in one.',
      'collections.create.title': 'New collection',
      'collections.create.message': 'Give it a name: trail, hiking, training...',
      'collections.create.placeholder': 'Trail',
      'collections.create.confirm': 'Create',
      'collections.created': 'Collection "{name}" created',
      'collections.rename.title': 'Rename collection',
      'collections.duplicate': 'You already have a collection with that name',
      'collections.delete.title': 'Delete collection',
      'collections.delete.message':
        'Delete "{name}"? The routes in it are not deleted: they go back to having no collection.',
      'collections.delete.confirm': 'Delete collection',
      'collections.deleted': 'Collection deleted',
      'collections.move.title': 'Move to',
      'collections.move.subtitle': '{count} routes selected',
      'collections.move.subtitle_one': '1 route selected',
      'collections.color': 'Colour',
      'collections.order.up': 'Move up',
      'collections.order.down': 'Move down',
      'collections.count': '{count} routes',
      'collections.count_one': '1 route',
      'collections.count_zero': 'Empty',

      'activity.rename.title': 'Route name',
      'activity.rename.message': 'Give it a name so you recognise it at a glance.',
      'activity.rename.placeholder': 'Climb to the pass',
      ...
      'detail.rename': 'Rename route',
      'detail.delete': 'Delete route',
      'detail.deleted': 'Route deleted',
      ...
      'tracking.permission_title': 'Preparing the map',
      'tracking.permission_message': 'Trackingfy is finding your position.',
      'tracking.notif_paused_title': 'Tracking paused',
      'tracking.notif_stats': '{distance} km · +{climb} m',
      'tracking.notif_stats_paused': '{distance} km · +{climb} m · {time}',
      'tracking.notif_action_pause': 'Pause',
      'tracking.notif_action_resume': 'Resume',
      'tracking.notif_action_finish': 'Finish',
